-- Migration script for Prompt Studio Support
...
-- Insert initial Cache Generator Prompt
INSERT OR IGNORE INTO ai_prompt_templates (prompt_key, system_role, template_body, fallback_message)
VALUES (
    'cache_generator_prompt',
...
<daily_tasks>
  <task>
    ...
    'দুঃখিত, সার্ভারে অতিরিক্ত চাপ থাকায় জেনারেট করা সম্ভব হচ্ছে না। কিছুক্ষণ পর আবার চেষ্টা করুন।'
);

-- Insert initial Cron Verifier Prompt
INSERT OR IGNORE INTO ai_prompt_templates (prompt_key, system_role, template_body, fallback_message)
VALUES (
    'cron_verifier_prompt',
    'Act as an expert Agronomist in Bangladesh. Provide data for EXACTLY 1 ACRE of land for the crop/variety: "{crop_name}".',
